...
describe('buildAggregateRepoWorkbook', () => {
  it('uses compact A/B/C columns for labels, samples/values, and response time', async () => {
    ...
    expect(sheet.getCell('B9').isMerged).toBe(true)
    ...
    expect(sheet.getCell('B13').isMerged).toBe(false)
    expect(sheet.getCell('B13').alignment?.horizontal).toBe('center')
    expect(sheet.getCell('C13').alignment?.horizontal).toBe('center')
    ...
    expect(sheet.getCell('B14').isMerged).toBe(false)
    expect(sheet.getCell('B14').alignment?.horizontal).toBe('center')
    expect(sheet.getCell('C14').alignment?.horizontal).toBe('center')
